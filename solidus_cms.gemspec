...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'Simple CMS for Solidus.'
  spec.description = 'Simple CMS for Solidus.'
  spec.homepage = 'https://github.com/solidusio-contrib/solidus_cms#readme'
  spec.license = 'BSD-3-Clause'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/solidusio-contrib/solidus_cms'
  spec.metadata['changelog_uri'] = 'https://github.com/solidusio-contrib/solidus_cms/blob/main/CHANGELOG.md'
